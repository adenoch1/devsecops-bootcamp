...
# task's environment at startup — the value never touches the task
# definition, Terraform plan output, or application code. The literal
# fallback here only ever runs locally: every real deployment always sets
# FLASK_SECRET_KEY, so this default is never reachable outside a laptop.
